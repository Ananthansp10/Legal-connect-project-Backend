...
exports.GetLawyerProfileRepository = void 0;
const lawyerProfileModel_1 = require("../models/lawyerProfileModel");
const baseRepository_1 = require("./baseRepository");
class GetLawyerProfileRepository extends baseRepository_1.BaseRepository {
  constructor() {
  ...
  getLawyerProfileImage(lawyerId) {
    return __awaiter(this, void 0, void 0, function* () {
      const lawyerDetails =
        yield lawyerProfileModel_1.lawyerProfileModel.findOne({
          lawyerId: lawyerId,
        });
      return (
...
exports.GetLawyerProfileRepository = GetLawyerProfileRepository;
