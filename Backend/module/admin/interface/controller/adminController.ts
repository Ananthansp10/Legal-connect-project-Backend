...
export class AdminController {
  ...
  async getReportedAccounts(req: Request, res: Response) {
    try {
      const result = await this._getReportedAccountUseCase.execute(
  ...
  async updateReportedAccountStatus(req: Request, res: Response) {
    try {
      await this._updateReportedAccountUseCase.execute(
        new mongoose.Types.ObjectId(req.params.reportedAccountId),
      );
      res
        .status(AppStatusCode.SUCCESS_CODE)
  ...
  async editPlan(req: Request, res: Response) {
    try {
      await this._editPlanUseCase.execute(
  ...
  async managePlanStatus(req: Request, res: Response) {
    try {
      await this._managePlanStatusUseCase.execute(
        new mongoose.Types.ObjectId(req.params.planId),
        req.params.status,
      );
      res
  ...
  async DeletePlanUseCase(req: Request, res: Response) {
    try {
      await this._deletePlanUseCase.execute(
        new mongoose.Types.ObjectId(req.params.planId),
      );
      res
        .status(AppStatusCode.SUCCESS_CODE)
