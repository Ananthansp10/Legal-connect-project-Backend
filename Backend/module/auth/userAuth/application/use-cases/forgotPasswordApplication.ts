...
import { IForgotPasswordApplication } from "../use-case-Interface/IforgotPasswordApllication";


export class ForgotPasswordApplication implements IForgotPasswordApplication{
