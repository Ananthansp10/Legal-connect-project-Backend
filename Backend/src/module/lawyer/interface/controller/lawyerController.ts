...
export class LawyerController {
  ...
  async updateAppointmentStatus(req: Request, res: Response) {
    try {
      await this._updateAppointmentStatusUseCase.execute(
  ...
  async addPlan(req: Request, res: Response) {
    try {
      await this._addPlanUseCase.execute(
        new mongoose.Types.ObjectId(req.params.lawyerId),
  ...
  async getChat(req: Request, res: Response) {
    try {
      const result = await this._getLawyerChatUseCase.execute(
        new mongoose.Types.ObjectId(req.params.lawyerId),
  ...
  async updateChatReadStatus(req: Request, res: Response) {
    try {
      await this._updateChatReadStatusUseCase.execute(
        new mongoose.Types.ObjectId(req.params.lawyerId),
        new mongoose.Types.ObjectId(req.params.userId),
      );
      res
  ...
  async startMeeting(req: Request, res: Response) {
    try {
      await this._startMeetingUseCase.execute(
        new mongoose.Types.ObjectId(req.params.appointmentId),
      );
      res
        .status(AppStatusCode.SUCCESS_CODE)
  ...
  async addNotes(req: Request, res: Response) {
    try {
      await this._addNotesUseCase.execute(
        new mongoose.Types.ObjectId(req.params.appointmentId),
        req.body.note,
      );
      res
  ...
  async addReview(req: Request, res: Response) {
    try {
      await this._addFeedBackUseCase.execute(
        new mongoose.Types.ObjectId(req.params.appointmentId),
        req.body,
      );
      res
